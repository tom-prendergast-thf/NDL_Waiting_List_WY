...
#directory = "../Files"
##file_path = os.path.join(directory, "Table4_6hip.xlsx")
...
plt.xlabel('EPP Referral Priority', fontsize=18)
...
plt.xlabel("Waiting Time (days)", fontsize=18)
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_3hip_all_group.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_3_hip.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_3_hip_not_in_did.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_1_Table_4_2hip.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_4_hip.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_5_hip.xlsx")
