...
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_6trauma_all.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_3_trauma_all.xlsx")
...
# Define the directory and file path
#directory = "../Files"
#file_path = os.path.join(directory, "Table4_1_Table_4_2trauma_all.xlsx")
